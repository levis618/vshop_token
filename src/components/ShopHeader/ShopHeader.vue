<template>
  <div class="shop-header">
    ...
    <div
      ...
      v-if="info.supports"
      @click="toggleSupports"
    >
      <div class="discounts-left">
        <div
          class="activity"
          :class="activityClasses[info.supports[0].type]"
        >
          <span class="content-tag">
    ...
    <transition name="nothing">
      ...
      >
        <transition name="move">
          <div
            class="activity-sheet-content"
            v-show="isShowSupports"
          >
            <template v-if="info.supports">
...
export default {
  ...
  methods: {
    toggleDiscounts () {
      this.isShowDiscounts = !this.isShowDiscounts
    },
    toggleSupports () {
